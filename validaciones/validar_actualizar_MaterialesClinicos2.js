	...
	function valida_actualizar_MaterialesClinicos2()
	{
		var Go =false;
		Go=$("#validar_actualizar_MaterialesClinicos2").validationEngine('validate');
		...
		if(Go==true)
		 ...
		 $.ajax({
				   ...
				   url:"../php/actualizar_MaterialesClinicos_2.php",
				   data: parametros,
	...
	function llegadaDatos(datos)
	{
		...
		$('#validar_actualizar_MaterialesClinicos2')[0].reset();
	}
