...
//$texto = $pdf->Cell(26,5,$data1['Clave_medicamento'],1,0,'C');
//$texto2 = $pdf->Cell(26,5,$data1['Clave_Medicamento_2'],1,0,'C');
//$texto3 = $pdf->Text(20,20,$data1['Clave_medicamento']);
//$texto4 = $pdf->Text(20,25,$data1['Clave_Medicamento_2']);

//$texto3 = $pdf->Write(20,20,$texto);
