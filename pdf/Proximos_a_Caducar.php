...
$result=mysql_query("SELECT * from medicamentos where DATE_ADD(FechaCaducacion,INTERVAL 3 MONTH) >= DATE_ADD(CURDATE(),INTERVAL 3 MONTH);",$conexion)or die(mysql_error());
...
$pdf->Cell(26,5,$data1['FechaCaducacion'],1,0,'C');
